...
window.config = {
  ...
  map: {
    ...
    'devextreme': 'npm:devextreme@23.1.4/cjs',
    'devextreme/bundles/dx.all': 'npm:devextreme@23.1.4/bundles/dx.all.js',
    'jszip': 'npm:jszip@3.7.1/dist/jszip.min.js',
    'devextreme-quill': 'npm:devextreme-quill@1.6.2/dist/dx-quill.min.js',
    'devexpress-diagram': 'npm:devexpress-diagram@2.1.75',
    'devexpress-gantt': 'npm:devexpress-gantt@4.1.47',
    'devextreme-angular': 'npm:devextreme-angular@23.1.4',
  ...
  packageConfigPaths: [
    ...
    'npm:devextreme-angular@23.1.4/*/package.json',
    'npm:devextreme-angular@23.1.4/ui/*/package.json',
    'npm:devextreme-angular@23.1.4/package.json',
    'npm:devexpress-diagram@2.1.75/package.json',
    'npm:devexpress-gantt@4.1.47/package.json',
  ],
};
